...
--changeset ${vr_owner_user}_CODE:TRIGGER_TRG_VRI_SETUP_INSERT runOnChange:TRUE  failOnError:TRUE splitStatements:FALSE

CREATE OR REPLACE TRIGGER TRG_VRI_SETUP_INSERT
  BEFORE INSERT ON VRI_SETUP 
  FOR EACH ROW 
  BEGIN
