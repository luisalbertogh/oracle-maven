...
FROM BOOK_HIERARCHY_RPL_QV_EXPANDED B
     JOIN (SELECT Y2.YEARDATE,
           ...
           FROM (SELECT TRUNC (SYSDATE) + 1 - ROWNUM AS YEARDATE
                 ...
                 JOIN (SELECT DISTINCT ASOFDATE
                       FROM BOOK_HIERARCHY_RPL_QV_EXPANDED) B2
