...
--changeset ${vr_owner_user}_CODE:PACKAGE_PKG_VRI_LIMIT_DAILY runOnChange:TRUE  failOnError:TRUE splitStatements:FALSE


  CREATE OR REPLACE PACKAGE "PKG_VRI_LIMIT_DAILY" AS 
/*****************************************************/
